...
import {calcMinWidth, updateColumns, createColumnKeys} from './util'
...
class ViewTable extends React.PureComponent {
  ...
  render () {
    ...
    console.log('--containerWidth=', this.props.containerWidth, ' calc minTableWidth=', minTableWidth)
    ...
    return (
      <div className='table-wrap'>
        <br />
        <pre><code><strong>minTableWidth ===</strong>{minTableWidth}</code></pre>
        <br />
        <ReactTable
